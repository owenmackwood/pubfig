...
```python
from pubfig import Units, FigureSpec, ElemSize, Panel, PanelFig, SVG, Location
from typing import NamedTuple
from pathlib import Path

units = Units.cm

class Figure1_Panels(NamedTuple):
